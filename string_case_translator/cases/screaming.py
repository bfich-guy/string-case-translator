...
def screaming_to_camel(*, variable_name: str) -> str | None:
    ...
    screaming_word_list: list[str] | None = get_string_list_of_delimiter_case(variable_name=variable_name, divider=screaming_divider)

    if screaming_word_list is None:
        return None
        
    camel_divider: str = case_dividers_dict[CaseDividersNames.CAMEL.value]
    camel_word_list: list[str] = [screaming_word.capitalize() if index > 0 else screaming_word.lower() for index, screaming_word in enumerate(screaming_word_list)]

    result: str | None = connect_strings_with_divider(string_list=camel_word_list, divider=camel_divider)
    return result

def screaming_to_dot(*, variable_name: str) -> str | None:
    ...
    dot_word_list: list[str] = [screaming_word.lower() for screaming_word in screaming_word_list]
...
def screaming_to_kebab(*, variable_name: str) -> str | None:
    ...
    kebab_word_list: list[str] = [screaming_word.lower() for screaming_word in screaming_word_list]
...
def screaming_to_pascal(*, variable_name: str) -> str | None:
    ...
    pascal_word_list: list[str] = [screaming_word.capitalize() for screaming_word in screaming_word_list]

    result: str | None = connect_strings_with_divider(string_list=pascal_word_list, divider=pascal_divider)
    return result

def screaming_to_path(*, variable_name: str) -> str | None:
    ...
    path_word_list: list[str] = [screaming_word.lower() for screaming_word in screaming_word_list]
...
def screaming_to_snake(*, variable_name: str) -> str | None:
    ...
    snake_word_list: list[str] = [screaming_word.lower() for screaming_word in screaming_word_list]

    result: str | None = connect_strings_with_divider(string_list=snake_word_list, divider=snake_divider)
    return result

def screaming_to_train(*, variable_name: str) -> str | None:
    ...
    train_word_list: list[str] = [screaming_word.capitalize() for screaming_word in screaming_word_list]
